...
/**
 * Generate a match string for this contact that can be used for matching and deduplication
 * @return A normalized string containing various contact properties
 */
