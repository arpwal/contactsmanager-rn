...
#pragma mark - CMServerContactSource

@interface CMServerContactSource : NSObject <NSCoding, NSSecureCoding>
...
@property (nonatomic, strong, nullable) NSString *organizationId;
@property (nonatomic, strong, nullable) NSString *canonicalContactId;
@property (nonatomic, strong, nullable, readonly) NSString *sourceId;
...
- (instancetype)initWithIdentifier:(nullable NSString *)identifier
                ...
                canonicalContactId:(nullable NSString *)canonicalContactId;
